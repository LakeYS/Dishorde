...
## Setting up the bot
1. [Download](https://github.com/LakeYS/7DTD-Discord/releases/download/v1.7.2/7DTD-Discord.zip) this repository and extract it somewhere on your server's system.
...
3. Type `curl -L https://github.com/LakeYS/7DTD-Discord/releases/download/v1.7.2/7DTD-Discord.tar.gz > 7dtdbot.tar.gz` to download the bot's files to an archive named `7dtdbot.tar.gz`.
